...
namespace XuLyKhoaLuan.Interface.NghiepVu
{
    ...
    {
        public Task<List<DeTaiDiemVTModel>> GetDanhSachDiemByGv(string maGv, string namHoc, int dot);
        public Task<List<DeTaiDiemVTModel>> GetDanhSachDiemBySv(string maSv);
